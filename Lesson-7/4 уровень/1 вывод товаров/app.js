...
function showCategory(category) {
    ...
    switch (category) {
        case "phones":
            productsFromCategory = products.phones;
            break;
        case "tablets":
            productsFromCategory = products.tablets;
            break;
        case "tv":
            productsFromCategory = products.tv;
            break;
    }
    productsFromCategory.forEach(function (product) {divProducts.insertAdjacentHTML("beforeend", getProductMarkup(product));
    });
}
